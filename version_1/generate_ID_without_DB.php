...
/*  $StudyDate $PatientName $PatientID $InstitutionName $StudyInstanceUID $SeriesInstanceUID
...
*/  
    ...
    $pieces_SOP= explode(".", $argv[7]);

    $Server_file_id='NBRC'.'.'.$argv[8].'.'.$argv[6].'.'.rand(1,9999).'.'.$pieces_SOP[9];
