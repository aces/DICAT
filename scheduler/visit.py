...
class VisitSetup():
    ...
    def __init__(self, rank, visitlabel, previousvisit = None, visitwindow = None, visitmargin = None,
                 optional='No', actions = None, uid=None):
...
class Visit(VisitSetup):
    ...
    """
    def __init__(self, rank, visitlabel, previousvisit, visitwindow, visitmargin, optional='No', actions=None, uid=None, when = None,
                 whenearliest = None, whenlatest = None, where = None, withwhom = None, status = None):
        VisitSetup.__init__(self, rank, visitlabel, previousvisit, visitwindow, visitmargin, optional, actions, uid)
        self.when = when
